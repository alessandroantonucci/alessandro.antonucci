...
\MakeShortVerb{\|}
\begin{document}
\title{The fontawesome5 package\thanks{This document corresponds to fontawesome5 version 5.15.3, dated 2021/06/04}}
...
\subsection*{Updates}
This package corresponds to Font Awesome 5.15.3.
